...
{{-- 
    ======================================================================
    CROSS COUNTRY TANDEM FLIGHT - FULLY RESPONSIVE VERSION
    ======================================================================
    - Premium 45-60 minute flight experience
    ...
    <div class="bg-gray-50 border-y border-gray-200 py-8 sm:py-10">
        <div class="container mx-auto px-4 sm:px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
                ...
                <div class="border-r border-gray-200 last:border-r-0 md:border-r px-2">
                    <div class="text-2xl sm:text-3xl md:text-4xl font-bold text-sky-500">60</div>
    ...
    <main id="course-details" class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
        ...
        <section class="max-w-6xl mx-auto mb-16 sm:mb-20 lg:mb-24">
            <div class="text-center mb-8 sm:mb-12 lg:mb-16">
                ...
                <p class="text-base sm:text-lg text-slate-600 max-w-3xl mx-auto px-4 sm:px-0">
                    This isn't just a flight; it's an hour-long aerial expedition. Soar over lush valleys, ancient monasteries, 
                    and ride the Himalayan thermals with an expert pilot on our longest tandem experience.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <div class="order-2 lg:order-1">
                    <img src="{{ asset('storage/p1.jpg') }}" 
                         alt="Paraglider taking off from mountain top" 
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        <div class="bg-gray-50 p-3 sm:p-4 rounded-lg flex items-start gap-3 sm:gap-4">
                            ...
                            <div class="text-sm sm:text-base">
                                <span class="font-semibold text-slate-700">Extended Flight:</span>
                                <span class="text-slate-600"> 45-60 minutes of pure flying bliss.</span>
                            </div>
                        </div>
                        <div class="bg-gray-50 p-3 sm:p-4 rounded-lg flex items-start gap-3 sm:gap-4">
                            <span class="text-emerald-500 font-bold text-lg sm:text-xl mt-0.5 flex-shrink-0">✓</span>
                            <div class="text-sm sm:text-base">
                                ...
                                <span class="text-slate-600"> Certified pilot with thousands of flight hours.</span>
                            </div>
                        </div>
                        <div class="bg-gray-50 p-3 sm:p-4 rounded-lg flex items-start gap-3 sm:gap-4">
                            <span class="text-emerald-500 font-bold text-lg sm:text-xl mt-0.5 flex-shrink-0">✓</span>
                            <div class="text-sm sm:text-base">
                                ...
                                <span class="text-slate-600"> HD GoPro video & photos of your journey.</span>
                            </div>
                        </div>
                        <div class="bg-gray-50 p-3 sm:p-4 rounded-lg flex items-start gap-3 sm:gap-4">
                            <span class="text-emerald-500 font-bold text-lg sm:text-xl mt-0.5 flex-shrink-0">✓</span>
                            <div class="text-sm sm:text-base">
                                <span class="font-semibold text-slate-700">Complete Safety:</span>
                                <span class="text-slate-600"> All equipment and briefing included.</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="booking" class="max-w-5xl mx-auto text-center bg-gradient-to-br from-sky-600 to-emerald-600 text-white p-8 sm:p-12 md:p-16 rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl">
            <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">
                Ready for the Ultimate Flight?
            </h3>
            <p class="mb-6 sm:mb-8 text-base sm:text-lg text-sky-100 max-w-2xl mx-auto px-4 sm:px-0">
                This is the longest and most thrilling tandem flight we offer. Book your spot for an unforgettable adventure.
            </p>
            ...
            <div class="space-y-3 sm:space-y-4" x-data="{ open: 1 }">
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div x-show="open === 1" x-transition class="px-4 pb-4 sm:px-5 sm:pb-5 text-sm sm:text-base text-slate-600">
                        <p>Not at all! This tandem flight is for everyone. Your certified pilot handles all controls while you enjoy the breathtaking hour-long journey.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div x-show="open === 2" x-transition class="px-4 pb-4 sm:px-5 sm:pb-5 text-sm sm:text-base text-slate-600">
                        <p>Absolutely! We use certified equipment, experienced pilots with thousands of flight hours, and only fly in safe weather conditions. Your safety is our top priority.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div x-show="open === 3" x-transition class="px-4 pb-4 sm:px-5 sm:pb-5 text-sm sm:text-base text-slate-600">
                        <p>Wear comfortable layered clothing and a windproof jacket (it's cooler at altitude). Sturdy closed-toe shoes are essential, and don't forget sunglasses!</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    <button @click="open = (open === 4 ? null : 4)" 
                            class="w-full flex justify-between items-center text-left p-4 sm:p-5 font-semibold text-base sm:text-lg text-slate-800">
                        <span class="pr-2 text-sm sm:text-base lg:text-lg">
                            Why is this flight longer and more expensive?
                        </span>
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 transform transition-transform text-slate-400" 
                    ...
                    <div x-show="open === 4" x-transition class="px-4 pb-4 sm:px-5 sm:pb-5 text-sm sm:text-base text-slate-600">
                        <p>This premium experience takes you on extended cross-country routes, exploring multiple valleys and peaks. The longer duration allows for thermal riding, higher altitudes, and covering greater distances - a true aerial adventure!</p>
                    </div>
                </div>
            </div>
        </section>
