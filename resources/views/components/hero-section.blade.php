...
<body>
<!-- Hero Section -->
<section class="relative w-full h-[75vh] overflow-hidden" x-data="{ muted: true, showLine1: false, showLine2: false, showLine3: false, showDesc: false, showBtn: false }" 
x-init="
...
>
<source src="storage/WhatsApp Video 2025-08-16 at 14.28.02.mp4" type="video/mp4">
...
class="absolute top-4 right-4 z-30 bg-black/50 hover:bg-orange-600/80 backdrop-blur-sm text-white p-3 rounded-full transition-all transform hover:scale-110"
>
...
<!-- CTA Button -->
<div>
<a href="/packages" class="group modern-button hover-lift inline-flex px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white text-xl font-bold rounded-full transition-all duration-700 shadow-xl ease-out" 
style="text-shadow: 1px 1px 2px rgba(0,0,0,0.3);"
...
<span class="transform group-hover:translate-x-2 group-hover:rotate-12 transition-all duration-300">🪂</span>
</span>
</a>
</div>
</div>
...
@keyframes glow {
 0%, 100% {
   text-shadow: 2px 2px 8px rgba(0,0,0,0.6), 0px 0px 15px rgba(255,140,0,0.2);
 }
 50% {
   text-shadow: 2px 2px 8px rgba(0,0,0,0.6), 0px 0px 25px rgba(255,140,0,0.4);
 }
}

/* Particle Animation with better physics */
.particle {
  position: absolute;
  width: 3px;
  height: 3px;
...
/* Animation Delays with smooth sequence */
.animation-delay-300 {
