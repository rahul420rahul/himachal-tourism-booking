<!DOCTYPE html>
<html lang="en">
<header class="w-full bg-white shadow-sm mt-0 pt-0">
    <!-- Your header content -->
    ...
    <style>
        ...
        /* Force dark black text for MyBirBilling */
       
        /* Remove this aggressive CSS */
.force-dark-text * {
...
<nav class="bg-white/95 backdrop-blur-2xl sticky top-0 z-50 transition-all duration-300 border-b border-gray-100/50 shadow-sm" x-data="{
  ...
  <!-- Top Info Bar (Desktop Only) with Red Background -->
  <div class="hidden lg:block bg-red-600 text-white py-3 px-6 lg:px-12 relative overflow-hidden">
    <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-10"></div>
    ...
    <div class="flex justify-between items-center h-16 lg:h-20">
      ...
      <div class="hidden lg:flex items-center space-x-8 xl:space-x-12">
        <a href="{{ route('home') }}" class="relative text-gray-600 hover:text-blue-600 font-semibold text-sm transition-all duration-300 group {{ request()->routeIs('home') ? 'text-blue-600' : '' }}" :class="{ 'text-blue-600': '{{ request()->routeIs('home') }}' }" aria-current="{{ request()->routeIs('home') ? 'page' : 'false' }}">
          ...
          <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-blue-600 to-indigo-700 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 {{ request()->routeIs('home') ? 'scale-x-100' : '' }}"></span>
        </a>
        <a href="{{ route('packages.index') }}" class="relative text-gray-600 hover:text-blue-600 font-semibold text-sm transition-all duration-300 group {{ request()->routeIs('packages.*') ? 'text-blue-600' : '' }}" :class="{ 'text-blue-600': '{{ request()->routeIs('packages.*') }}' }" aria-current="{{ request()->routeIs('packages.*') ? 'page' : 'false' }}">
          ...
          <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-blue-600 to-indigo-700 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 {{ request()->routeIs('packages.*') ? 'scale-x-100' : '' }}"></span>
        </a>
          ...
          <div x-show="servicesOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="absolute top-full left-1/2 transform -translate-x-1/2 mt-3 w-[90vw] max-w-5xl bg-white rounded-2xl shadow-2xl border border-gray-100/50 p-8 z-50" @click.outside="servicesOpen = false" role="menu" aria-label="Services submenu">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div class="space-y-3">
                  <a href="{{ route('services.tandem') }}" class="flex items-start space-x-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 group" role="menuitem">
                  ...
                  <a href="#" class="flex items-start space-x-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition-all duration-300 group" role="menuitem">
                    <div class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                      <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div>
                ...
                <div class="space-y-3">
                  ...
                  <a href="#" class="flex items-start space-x-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-orange-50 hover:to-red-50 transition-all duration-300 group" role="menuitem">
                    <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                      <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div>
                <h3 class="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4 flex items-center">
                  <svg class="w-5 h-5 mr-2 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                  </svg>
                  Equipment & More
                </h3>
                <div class="space-y-3">
                  <a href="{{ route('services.rental') }}" class="flex items-start space-x-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-slate-50 hover:to-gray-50 transition-all duration-300 group" role="menuitem">
                    <div class="w-12 h-12 bg-gradient-to-br from-slate-500 to-gray-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                      <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                      </svg>
                    </div>
                  ...
                  <a href="{{ route('safety') }}" class="flex items-start space-x-4 p-4 rounded-xl hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 transition-all duration-300 group" role="menuitem">
                    <div class="w-12 h-12 bg-gradient-to-br from-red-500 to-rose-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                      <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="{{ route('gallery') }}" class="relative text-gray-600 hover:text-blue-600 font-semibold text-sm transition-all duration-300 group {{ request()->routeIs('gallery') ? 'text-blue-600' : '' }}" :class="{ 'text-blue-600': '{{ request()->routeIs('gallery') }}' }" aria-current="{{ request()->routeIs('gallery') ? 'page' : 'false' }}">
          ...
          <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-blue-600 to-indigo-700 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 {{ request()->routeIs('gallery') ? 'scale-x-100' : '' }}"></span>
        </a>
        <a href="{{ route('contact') }}" class="relative text-gray-600 hover:text-blue-600 font-semibold text-sm transition-all duration-300 group {{ request()->routeIs('contact') ? 'text-blue-600' : '' }}" :class="{ 'text-blue-600': '{{ request()->routeIs('contact') }}' }" aria-current="{{ request()->routeIs('contact') ? 'page' : 'false' }}">
          ...
          <span class="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-blue-600 to-indigo-700 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 {{ request()->routeIs('contact') ? 'scale-x-100' : '' }}"></span>
        </a>
      </div>
      ...
      <div class="hidden lg:flex items-center space-x-6">
        <!-- Search Button -->
        <button @click="searchOpen = !searchOpen" class="w-10 h-10 bg-gray-100 hover:bg-blue-100 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500" aria-label="Open search">
          <svg class="w-5 h-5 text-gray-600 hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div x-data="{ mobileMenuOpen: false }" class="lg:hidden">
        <button 
          ...
          class="p-2.5 rounded-xl bg-gray-100 hover:bg-blue-100 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500" 
  ...
  <div x-show="searchOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="absolute top-full left-0 w-full bg-white border-t border-gray-100/50 shadow-lg p-6" @click.outside="searchOpen = false" role="dialog" aria-label="Search modal">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mt-4 flex flex-wrap gap-3">
        ...
        <a href="#" class="px-3 py-1.5 bg-blue-100 hover:bg-blue-200 rounded-full text-sm font-medium text-blue-700 transition-colors duration-300">Tandem Flights</a>
        <a href="#" class="px-3 py-1.5 bg-indigo-100 hover:bg-indigo-200 rounded-full text-sm font-medium text-indigo-700 transition-colors duration-300">Basic Course</a>
        <a href="#" class="px-3 py-1.5 bg-green-100 hover:bg-green-200 rounded-full text-sm font-medium text-green-700 transition-colors duration-300">Weekend Packages</a>
        <a href="#" class="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 rounded-full text-sm font-medium text-slate-700 transition-colors duration-300">Group Booking</a>
      </div>
    </div>
  </div>
</nav>
